...
def create_question(question_text, days):
    ...
    negative for question in the past, positive for questions that have yet to be published
...
class QuestionDetailViewTests(TestCase):
    ...
    def test_past_question(self):
        ...
        past_question = create_question(question_text="past question", days=-50)
